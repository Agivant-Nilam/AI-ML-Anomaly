...
Original file is located at
    https://colab.research.google.com/drive/1ll5Ygx9kGLdtNP89fnCEaQDBgQoTMCr-
"""
    ...
    def process(self, element):
        ...
        for record in data:
            ...
            if text:
                ...
                input: \"Hello, I need information regarding the warranty for product X in order #01982 #Unknown. I am very pleased with this.
                This is wonderful news. .
                Please keep up the great work.\"
    ...
    def process(self, element):
        ...
        for record in element:
            ...
            if text:
                ...
                I received my order (Order ID: #33916) and I\'m incredibly disappointed with the product quality. The item is unusable due to its extremely poor quality. I request immediate attention to this matter.\"
...
class AnalyzeOrderId(beam.DoFn):
    ...
    def process(self, element):
        ...
        for record in element:
            ...
            if text:
                prompt = """
                Extract the order Id  from the text below in a JSON format.
...
def run():
    ...
    with beam.Pipeline(options=options) as p:
        (p
         ...
         | 'AnalyzeSentiment' >> beam.ParDo(AnalyzeSentiment(project, 'us-central1', 'text-bison', bucket_name))
         ...
         | 'WriteToBigQuery' >> WriteToBigQuery(
                output_table,
                schema='Timestamp: TIMESTAMP , Email Text:str, subject: str , sentiment:str,category:str, order_id:str',
